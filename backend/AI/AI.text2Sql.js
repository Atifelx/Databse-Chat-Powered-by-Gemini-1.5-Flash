...
4. Default Behaviors:
   - #IMPORTANT If question is unclear → SELECT * FROM students;.
...
User Question: ${query}
    ...
    let generatedQuery = response.data.candidates[0]?.content?.parts[0]?.text || "Apologies! not able to find in database";
